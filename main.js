const api_key = "355ab2e6379d250f0bf11cd90c73059f";
...
const loadForecastDataUsingGeoLocation = () => {
...
function debounce(func) {
    let timer;
    return (...args) => {
        clearTimeout(timer); //Clear Earlier Timer
...
document.addEventListener("DOMContentLoaded", async() => {
    loadForecastDataUsingGeoLocation();
